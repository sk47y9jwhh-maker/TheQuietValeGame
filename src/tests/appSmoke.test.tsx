...
describe("app smoke flow", () => {
  ...
  it("confirms Steward starts and shows the first seeding screen", () => {
    render(<App />);
    ...
    fireEvent.click(screen.getByRole("button", { name: /confirm knight start/i }));
  ...
  it("advances from player seeding to reveal", () => {
    render(<App />);
