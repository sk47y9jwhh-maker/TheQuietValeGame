...
const ledgerEntryDefinitions: LedgerEntry[] = [
  {"id":"LE-001","name":"The Vale Endures","chronicle":"Settlement Records","entryType":"Record","scope":"By player count","pacingBand":"Standard","countsTowardUnlock":true,"playerCountPrestige":true,"unlockAt":6,"declaredVow":false,"requiredSteward":null,"thresholdsByPlayerCount":{"1":140,"2":200,"3":280,"4":320},"cumulativeCounter":null,"requirement":"Record a final score at or above the threshold for that player count: 140 / 200 / 280 / 320 in 1p / 2p / 3p / 4p. Available after 6 named Ledger Entries have been completed."},
  ...
  {"id":"LE-041","name":"No Roads Raised","chronicle":"Vows","entryType":"Vow","scope":"By player count","pacingBand":"Capstone","countsTowardUnlock":true,"playerCountPrestige":true,"unlockAt":25,"declaredVow":true,"requiredSteward":null,"thresholdsByPlayerCount":{"1":90,"2":130,"3":190,"4":240},"cumulativeCounter":null,"requirement":"Available after 25 named Ledger Entries have been completed. Declare before setup. Place no Travel Tiles and reach a final score of at least 90 / 130 / 190 / 240 in 1p / 2p / 3p / 4p. Any Steward Power, Boon, or Golden effect that places a Travel Tile breaks this Vow. Only one Steward’s Ledger Vow may be declared per game."},
  {"id":"LE-042","name":"No Fine Work","chronicle":"Vows","entryType":"Vow","scope":"By player count","pacingBand":"Capstone","countsTowardUnlock":true,"playerCountPrestige":true,"unlockAt":28,"declaredVow":true,"requiredSteward":null,"thresholdsByPlayerCount":{"1":110,"2":85,"3":75,"4":40},"cumulativeCounter":null,"requirement":"Available after 28 named Ledger Entries have been completed. Declare before setup. Upgrade no Core Tiles by any source and reach a final score of at least 110 / 85 / 75 / 40 in 1p / 2p / 3p / 4p. Any Steward Power, Boon, or Golden effect that upgrades a Core Tile breaks this Vow. Only one Steward’s Ledger Vow may be declared per game."},
  {"id":"LE-043","name":"The Small Storehouse","chronicle":"Vows","entryType":"Vow","scope":"Once","pacingBand":"Capstone","countsTowardUnlock":true,"playerCountPrestige":false,"unlockAt":34,"declaredVow":true,"requiredSteward":null,"thresholdsByPlayerCount":null,"cumulativeCounter":null,"requirement":"Available after 34 named Ledger Entries have been completed. 3–4 players only. Declare before setup. The Warehouse may never hold more than 8 of any resource type at any time. Only one Steward’s Ledger Vow may be declared per game."},
...
export function isVowAvailableForPlayerCount(vowId: string | undefined, playerCount: number): boolean {
  return vowId !== "LE-043" || playerCount >= 3;
}
